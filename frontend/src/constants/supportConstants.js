...
export const SUPPORT_DETAILS_BY_STATUS_REQUEST = 'SUPPORT_DETAILS_BY_STATUS_REQUEST'
export const SUPPORT_DETAILS_BY_STATUS_SUCCESS = 'SUPPORT_DETAILS_BY_STATUS_SUCCESS'
export const SUPPORT_DETAILS_BY_STATUS_FAIL = 'SUPPORT_DETAILS_BY_STATUS_FAIL'
