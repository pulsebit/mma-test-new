...
export const SUPPORT_LIST_BY_CREATOR_REQUEST = 'SUPPORT_LIST_BY_CREATOR_REQUEST'
export const SUPPORT_LIST_BY_CREATOR_SUCCESS = 'SUPPORT_LIST_BY_CREATOR_SUCCESS'
export const SUPPORT_LIST_BY_CREATOR_FAIL = 'SUPPORT_LIST_BY_CREATOR_FAIL'
...
export const SUPPORT_DELETE_RESET = 'SUPPORT_DELETE_FAIL' 